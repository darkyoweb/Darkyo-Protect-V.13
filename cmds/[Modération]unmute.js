...
module.exports.run = async(bot, message, args) => {
      ...
      if (!message.guild.member(bot.user).hasPermission("ADMINISTRATOR")) return message.channel.send("Je n'ai pas la __permission:__ __**\"ADMINISTRATEUR\"**__, je ne peux donc pas faire le *unmut+*")
      ...
      const muteRole = message.guild.roles.cache.find(role => role.name === 'Mute By Darkyo#0001')
