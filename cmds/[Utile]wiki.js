...
module.exports.run = async (client, message, args) => {
        ...
        if(!wiki) return message.reply('**Merci de founir une recherche !** :x:') // If No Topic Provided To Searched
        ...
        try {
            ...
            return message.reply(':x: Fournissez une requête valide pour la recherche. ') // If Searched Topic Is Not Available
        }
    }
